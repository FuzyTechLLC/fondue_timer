            ...
            TextButton(
              ...
              onPressed: () {
                try {
                  Navigator.pop(
                    context,
                    TimerData(name: nameController.text, color: chosenColor, time: ClkTimer(timeDur: Duration(minutes: int.parse(minuteController.text), seconds: int.parse(secondController.text)))),
                  );
                } catch (_) {
